...
{
    QSettings settings(QSettings::UserScope, "matsyaos", "dock_pinned");
    QSettings systemSettings("/etc/matsya-dock-list.conf", QSettings::IniFormat);
    ...
    // Launcher
    //ApplicationItem *item = new ApplicationItem;
    //item->id = "matsya-launcher";
   // item->exec = "matsya-launcher";
