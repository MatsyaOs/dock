...
void TrashManager::moveToTrash(QList<QUrl> urls)
{
    ...
    QProcess::startDetached("matsya-filemanager", QStringList() << "--move-to-trash" << paths);
}

void TrashManager::emptyTrash()
{
    QProcess::startDetached("matsya-filemanager", QStringList() << "-e");
}

void TrashManager::openTrash()
{
    QProcess::startDetached("matsya-filemanager", QStringList() << "trash:///");
}
