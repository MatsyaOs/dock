...
Item {
    ...
    Rectangle {
        ...
        property var borderColor: root.compositing ? MatsyaUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.3)
        ...
        color: MatsyaUI.Theme.darkMode ? "#666666" : "#E6E6E6"
        opacity: root.compositing ? MatsyaUI.Theme.darkMode ? 0.5 : 0.5 : 0.9
