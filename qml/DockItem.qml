/*
 * Copyright (C) 2021 MatsyaSOS Team.
 *
        ...
        onContainsMouseChanged: {
            if (containsMouse && control.popupText !== "") {
                ...
                if (Settings.direction === DockSettings.Left)
                    popupTips.position = Qt.point(root.width + MatsyaUI.Units.largeSpacing,
                                                  control.mapToGlobal(0, 0).y + (control.height / 2 - popupTips.height / 2))
                else if (Settings.direction === DockSettings.Right)
                    popupTips.position = Qt.point(control.mapToGlobal(0, 0).x - popupTips.width - MatsyaUI.Units.smallSpacing / 2,
                                                  control.mapToGlobal(0, 0).y + (control.height / 2 - popupTips.height / 2))
                else
                    popupTips.position = Qt.point(control.mapToGlobal(0, 0).x + (control.width / 2 - popupTips.width / 2),
                                                  control.mapToGlobal(0, 0).y - popupTips.height - MatsyaUI.Units.smallSpacing)
